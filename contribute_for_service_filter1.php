                                ...
                                <div class="tab-pane active" id="home-1" role="tabpanel">
                                    <p class="mb-0">
                                        ...
                                        <div class="card-border">
                                            <div class="card-body">
                                                <form class="row row-cols-lg-auto g-3 align-items-center" novalidate action="contribute_for_service_filter2.php" method ="GET" >
                                                    <div class="col-12">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <h7 class="card-title mt-0"></h7>
                                                        ...
                                                        <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                                            ...
                                                            <tbody>
                                                                <?Php
                                                                    $query="select * from tpayments inner join households on tpayments.hhCode = households.hhcode where ((con = '$constituency') and (households.selected_product <> '00') and (households.enrolled = '1') and (households.product_approved = '1') and (households.agree_tcs = '1'))";
