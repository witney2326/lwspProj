                                ...
                                <div class="tab-pane active" id="home-1" role="tabpanel">
                                    <p class="mb-0">
                                        ...
                                        <div class="card-border">
                                            <div class="card-body">
                                                <form class="row row-cols-lg-auto g-3 align-items-center" novalidate action="works_tracking_ongoing_projects_filter3.php" method ="GET" >
                                                    <div class="col-12">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <div class="card-header bg-transparent border-primary">
                                                    <h5 class="my-0 text-primary">On-going Works</h5>
                                                </div>
                                                <div class="card-body">
