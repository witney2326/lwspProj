...
<head>
    <title>OSS Works|Products</title>
                ...
                <div class="row">
                    <div class="col-9">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">Oss Edit Product</h4>
                            ...
                            <div class="card border border-success">
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="OSS_product_edit.php">
                                        <div class="row mb-1">
                                            <label for="productID" class="col-sm-2 col-form-label">Product Code</label>
                                            <input type="text" class="form-control" id="productID" name = "productID" value="<?php echo $id;?>" style="max-width:30%;" readonly >
                                            
                                            <label for="pdname" class="col-sm-2 col-form-label">Product Name</label>
                                        ...
                                        <div class="row justify-content-end">
                                            <div>
                                                ...
                                                <button type="submit" class="btn btn-btn btn-outline-success w-md" name="Edit" value="Add">Edit Product</button>
