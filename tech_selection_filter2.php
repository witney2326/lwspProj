                        ...
                        <div class="card">
                            ...
                            <ul class="nav nav-pills nav-justified" role="tablist">
                                ...
                                <div class="card-border">
                                    <div class="card-body">
                                        <form class="row row-cols-lg-auto g-3 align-items-center" novalidate action="tech_selection_filter3.php" method ="GET" >
                                            <div class="col-12">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <h7 class="card-title mt-0"></h7>
                                                ...
                                                <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                                    ...
                                                    <tbody>
                                                        <?Php
                                                            $query="select * from households where ((ward = '$ward') and  (selected_product <> '00') and (enrolled = '1') and (product_approved = '0'))";
