                    ...
                    <div class="col-xl-12">
                        ...
                        <div class="card">
                                ...
                                <div class="card-border">
                                    ...
                                    <div class="card-body">
                                        <form class="row row-cols-lg-auto g-3 align-items-center" novalidate action="OSS_reports_registration_area.php" method ="GET" >
                                            <div class="col-12">
                                                ...
                                                <table id="datatable-buttons" class="table table-bordered dt-responsive  nowrap w-100">
                                                    ...
                                                    <tbody>
                                                        <?Php
                                                            ...
                                                            FROM households where ward = '$ward' group by ward,area";
