                        ...
                        <div class="w-100">
                            ...
                            <div class="d-flex flex-column h-100">
                                ...
                                <div class="my-auto">
                                    ...
                                    <div>
                                        <h5 class="text-primary">Register LWSP Contractor account</h5>
                                        ...
                                        <form class="needs-validation" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
                                            ...
                                            <div class="mb-1">
                                                ...
                                                <select class="form-select" name="position" id="position" required >
                                                    ...
                                                    <?php                                                           
                                                            $ta_fetch_query = "SELECT roleid,rolename FROM userroles";                                                  
                                            ...
                                            <div class="mb-1 <?php echo (!empty($cname_err)) ? 'has-error' : ''; ?>">
                                                <label for="cname" class="form-label">Enter Contractor Name</label>
                                            ...
                                            <div class="mb-1 <?php echo (!empty($caddress_err)) ? 'has-error' : ''; ?>">
                                                <label for="caddress" class="form-label">Enter Contractor Address</label>
                                            ...
                                            <div class="mb-1 <?php echo (!empty($cphone_err)) ? 'has-error' : ''; ?>">
                                                <label for="cphone" class="form-label">Enter Contractor Phone</label>
                                                <input type="text" class="form-control" id="cphone" name="cphone" value="<?php echo $cphone; ?>" >
                                                <span class="text-danger"><?php echo $cphone_err; ?></span>
                                            </div>

                                            <div class="mb-1 <?php echo (!empty($username_err)) ? 'has-error' : ''; ?>">
                                                <label for="username" class="form-label">Enter Platform Username</label>
