                                    ...
                                    <div class="col-12">
                                        ...
                                        <h7 class="card-title mt-0"></h7>
                                                ...
                                                <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                                    ...
                                                    <tbody>
                                                        <?Php
                                                            $query="select * from households where ((enrolled='1') and (con ='$constituency') and (ward='$ward') and (ready_selection = '1') and (deleted = '0') and (need_tech_guidance_on_selection = '0') and (selected_product = '00'))";
