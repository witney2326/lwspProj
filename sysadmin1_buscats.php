                                                                ...
                                                                <tbody>
                                                                    <?Php
                                                                        ...
                                                                        { 
                                                                            ...
                                                                            echo "<td>
                                                                                <a href=\"OSS_edit_product.php?id=".$row['pID']."\"><i class='fas fa-edit' title='Edit OSS Product' style='font-size:18px;color:green'></i></a>
                                                                                <a onClick=\"javascript: return confirm('Are You Sure You want To Delete This OSS Product ');\" href=\"OSS_product_delete.php?id=".$row['pID']."\"><i class='far fa-trash-alt' title='Delete SLG' style='font-size:18px;color:Red'></i></a>
                                                                             </td>\n";
                                                                            echo "</tr>";
                                                                        }
                                                                        $result_set->close();
