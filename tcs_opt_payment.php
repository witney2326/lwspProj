...
<head>
    <title>OSS Payment Option</title>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">OSS Payment Option</h4>

                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="index_check.php">Dashboard</a></li>
                                    <li class="breadcrumb-item active">OSS Payment Option</li>
                                </ol>
                            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-border">
                                <div class="card-body">
                                    ...
                                    <form class="row row-cols-lg-auto g-3 align-items-center" novalidate action="tcs_opt_payment_filter1.php" method ="POST" >
                                        <div class="col-12">
                                ...
                                <div class="col-12">
                                    ...
                                    <h7 class="card-title mt-0"></h7>
                                            ...
                                            <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                                ...
                                                <tbody>
                                                    <?Php
                                                        $query="select * from households where ((selected_product <> '00') and (enrolled = '1') and (product_approved = '1'))";
