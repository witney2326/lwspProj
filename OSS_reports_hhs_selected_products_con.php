                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">OSS Product Selection Reports</h4>
                    ...
                    <div class="col-xl-12">
                        ...
                        <div class="card">
                                ...
                                <div class="card-border">
                                    ...
                                    <div class="card-body">
                                        <form class="row row-cols-lg-auto g-3 align-items-center" novalidate action="OSS_reports_hhs_selected_products_ward.php" method ="GET" >
                                            <div class="col-12">
                                    ...
                                    <div class="col-12">
                                        <div class="card-border">
                                            ...
                                            <div class="card-header bg-transparent border-primary">
                                                <p><center><h5 class="my-0 text-primary">OSS Product Selection</h5></p></center>
                                            ...
                                            <table id="datatable-buttons" class="table table-bordered dt-responsive  nowrap w-100">
                                                ...
                                                <tbody>
                                                    <?Php
                                                        ...
                                                        FROM households where ((enrolled ='1') and (product_approved = '1') and con = '$constituency') group by selected_product ";
