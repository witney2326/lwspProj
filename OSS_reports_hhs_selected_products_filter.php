...
<head>
    <title>LWSP |Household OSS Products</title>
        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">Household OSS Products</h4>
                ...
                <div class="card-border">
                    ...
                    <div class="card-body">
                        <form class="row row-cols-lg-auto g-3 align-items-center" novalidate action="OSS_reports_hhs_selected_products_con.php" method ="GET" >
                            <div class="col-12">
