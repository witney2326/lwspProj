                    ...
                    <div class="col-xl-12">
                        ...
                        <div class="card">
                                ...
                                <div class="card-border">
                                    ...
                                    <div class="card-body">
                                        <form class="row row-cols-lg-auto g-3 align-items-center" novalidate action="OSS_reports_hhs_selected_products_area.php" method ="GET" >
                                            <div class="col-12">
                                                ...
                                                <table id="datatable-buttons" class="table table-bordered dt-responsive  nowrap w-100">
                                                    ...
                                                    <tbody>
                                                        <?Php
                                                            ...
                                                            FROM households where ((enrolled ='1') and (product_approved = '1') and ward = '$ward') group by selected_product ";
