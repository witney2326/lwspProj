                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="card-border">
                                    <div class="card-body">
                                        <form class="row row-cols-lg-auto g-3 align-items-center" novalidate action="target_ben_filter3.php" method ="GET" >
                                            <div class="col-12">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <h7 class="card-title mt-0"></h7>
                                                ...
                                                <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                                    ...
                                                    <tbody>
                                                        <?Php
                                                            $query="select * from households where ((ward = '$ward') and (deleted = '0'))";
