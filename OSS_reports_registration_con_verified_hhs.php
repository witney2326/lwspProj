                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">Verified/Accepted Household Reports</h4>
                    ...
                    <div class="col-xl-12">
                        ...
                        <div class="card">
                                ...
                                <div class="card-border">
                                    ...
                                    <div class="card-body">
                                        <form class="row row-cols-lg-auto g-3 align-items-center" novalidate action="OSS_reports_registration_verified_hhs_ward.php" method ="GET" >
                                            <div class="col-12">
